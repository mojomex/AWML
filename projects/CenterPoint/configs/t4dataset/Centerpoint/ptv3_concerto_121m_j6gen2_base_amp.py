_base_ = [
    ...
    "../../default/ptv3_concerto_base.py",
]
custom_imports = dict(imports=["projects.CenterPoint.models", "projects.Concerto.concerto"], allow_failed_imports=False)
...
experiment_name = "ptv3_concerto_121m_j6gen2_base_amp"
